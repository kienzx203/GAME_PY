...
class TroChoi:
    ...
    def __init__(self, duong_dan_hinh_nen, tieu_de, chieu_rong, chieu_cao):
        ...
        self.hinh_nen = pygame.transform.scale(
            hinh_nen, (chieu_rong, chieu_cao))
    ...
    def chay_vong_lap_game(self, he_so_toc_do):
        ...
        # Tao các đối tượng
        nhan_vat_nguoi_choi = NhanVatNguoiChoi(
            'nhan_vat.png', 375, 700, 50, 50)
        ...
        while not game_over:
            ...
            if nhan_vat_nguoi_choi.kiem_tra_va_cham(quan_thu_0):
                ...
                dong_ho.tick(1)
            elif nhan_vat_nguoi_choi.kiem_tra_va_cham(quan_thu_1):
                game_over = True
                chien_thang = False
                van_ban = font.render('You lost :(', True, MAU_DEN)
                self.man_hinh_game.blit(van_ban, (300, 350))
                pygame.display.update()
                dong_ho.tick(1)
            elif nhan_vat_nguoi_choi.kiem_tra_va_cham(quan_thu_2):
                game_over = True
                chien_thang = False
                van_ban = font.render('You lost :(', True, MAU_DEN)
                self.man_hinh_game.blit(van_ban, (300, 350))
...
class DoiTuongGame:
    def __init__(self, duong_dan_hinh_anh, x, y, chieu_rong, chieu_cao):
        ...
        self.hinh_anh = pygame.transform.scale(
            hinh_doi_tuong, (chieu_rong, chieu_cao))
...
tro_choi = TroChoi('hinh_nen.png', TIEU_DE_MAN_HINH,
                   CHIEU_RONG_MAN_HINH, CHIEU_CAO_MAN_HINH)
